...
python3 -m py_compile \
  "$project_dir/scripts/prepare-phase1-qwen-lr-pilot.py" \
  ...
  "$project_dir/scripts/check-phase1-qwen-sampler-repeat.py" \
  "$project_dir/scripts/diagnose-phase1-qwen-client-control.py" \
  "$project_dir/scripts/check-phase1-qwen-client-control.py" \
  "$project_dir/scripts/run-phase1-qwen-model-preflights.py" \
  "$project_dir/scripts/check-phase1-qwen-model-execution.py" \
  ...
  "$project_dir/scripts/check-phase1-read-surface-v7.py" \
  ...
  "$project_dir/scripts/serve-phase1-read-semantic-review.py" \
  "$project_dir/scripts/check-phase1-read-semantic-review.py" \
